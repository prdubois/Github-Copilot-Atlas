...
|------|-------|------|--------|
| **Orchestrator** | Claude Opus 4.8 | Expensive | AtlasOpus |
| **Senior** | DeepSeek-V4-Pro | Moderate | Daedalus, Security-Review, Code-Review, PowerBI |
| **Mid-Level** | DeepSeek-V4-Flash | Cheap | Odysseus, Refactor-Engineer, Security-Fix |
