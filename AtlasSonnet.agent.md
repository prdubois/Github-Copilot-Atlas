...
- Tell them to add detailed entry to dev_journal.md with timestamp, exec summary, and implementation details
- Remind them to update CHANGELOG.md and VERSION file if user-facing changes were made
- They will autonomously decide when new documentation is justified (new modules, major architecture changes, etc.)
- If uncertain about creating new docs, they will delegate the decision back to you (not the user)
- Use to prevent documentation proliferation and maintain documentation hygiene
</subagent_instructions>
