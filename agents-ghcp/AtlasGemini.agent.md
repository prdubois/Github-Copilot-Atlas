...
|------|-------|------|--------|
| **Orchestrator** | Gemini 3.5 Flash| Moderate | You (Gemini 3.5 Flash) |
| **Worker** | Various | Moderate | Sisyphus, Frontend-Engineer, Refactor-Engineer, Security-Fix, Security-Review, Code-Review, PowerBI |
